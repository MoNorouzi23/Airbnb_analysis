# note to do: add code to save models and run 
...
def main():
    ...
    results_rf = {'randomforest' : cv_rf.agg(['mean', 'std']).round(3).T}
    ...
    results_xgb = {'XGBoost' : cv_rf.agg(['mean', 'std']).round(3).T}
    ...
    results_lgbm = {'LGBM' : cv_rf.agg(['mean', 'std']).round(3).T}
